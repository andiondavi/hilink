<div align="center">
  <br />
    <img src="https://i.imgur.com/MQLK2gF.png" alt="Project Banner">
  <br />
  <br />
  ...
  <h3 align="center">UI/UX Travel Website/Landing Page</h3>
</div>
...
Hilink - UX/UI Travel Website, developed using Next.js, Typescript and Tailwind CSS. It's sleek design and overall user experience set a high standard, serving as a reference or inspiration for future modern applications or websites in general.
...
```bash
git clone https://github.com/andiondavi/hilink.git
cd hilink
```
...
export const SOCIALS = {
  title: 'Social',
  links: [
    { imageUrl: '/facebook.svg', url: 'https://facebook.com' },
    { imageUrl: '/instagram.svg', url: 'https://instagram.com' },
    { imageUrl: '/twitter.svg', url: 'https://twitter.com' },
    { imageUrl: '/youtube.svg', url: 'https://youtube.com' },
    { imageUrl: '/wordpress.svg', url: 'https://wordpress.com' },
  ],
};
```
...
- [Assets](https://drive.google.com/file/d/10bwdMeLAl7scTjrorqtG3v2Z6b4b7S-w/view?usp=sharing)
- [Live Website](https://hilink-davi-andions-projects.vercel.app/)
