                        ...
                        <div className="flex flex-col gap-5">
                            <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                                {FOOTER_CONTACT_INFO.links.map((link) => (
                                    <Link href="/" key={link.label} className="flex gap-4 items-center md:flex-col md:items-start lg:flex-row lg:items-center">
                                ...
                                <ul className="regular-14 flex gap-4 text-gray-30">
                                    {SOCIALS.links.map((social) => (
                                        <Link href={social.url} key={social.url}>
                                            <Image src={social.imageUrl} alt="social media icon" width={24} height={24}/>
                                        </Link>
                                    ))}
                                </ul>
                            </FooterColumn>
